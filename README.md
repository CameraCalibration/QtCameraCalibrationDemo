 ...
 *  Clone the repository inside the directory solution:
 ...
 ``
 git clone https://github.com/CameraCalibration/QtCameraCalibrationDemo.git
 ``
 
 *  Open QtCreator and open the file **QtCameraCalibrationDemo.pro**.
